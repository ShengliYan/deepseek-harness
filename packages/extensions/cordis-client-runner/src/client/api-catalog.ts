...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'fork(opts: { sessionId: SessionId; atSeq?: number; rewind?: boolean; increaseTitle?: boolean }): Promise<SessionId>',
        ...
        parameters: [{ name: 'opts', description: 'source session id, the optional event seq anchoring the cut (the boundary is the first turn/end at or after it; an in-log anchor in an open turn is unavailable rather than clipped backward), whether `rewind` cuts BEFORE the anchor\'s turn instead (the rewind-and- resend path; an anchor in the first turn yields an empty child), and whether to increment an inherited durable title before resolving.' }],

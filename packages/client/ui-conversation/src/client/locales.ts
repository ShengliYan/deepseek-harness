...
export const zh = {
  ...
  'message.stopped': '已停止',
  'message.branch': '从此处回退，在新会话中继续',
  'message.branchUnavailable': '仅可从已完成轮次的最后一条消息分支',
  'message.rewind': '从此处回退并编辑',
  'versions.previous': '上一个版本',
  'versions.next': '下一个版本',
...
export const en = {
  ...
  'message.branch': 'Rewind here - continue in a new conversation',
  'message.branchUnavailable': 'Available only on the last message of a completed turn',
  'message.rewind': 'Rewind and edit from here',
  'versions.previous': 'Previous version',

...
// prepend anchoring always target the resolved scrollport. History paging is
// gesture-driven: reader scroll reaching the very top pulls the next older
// page (anchored like the click it replaced), and a loaded window shorter
// than its scrollport pages itself until it overflows.
//

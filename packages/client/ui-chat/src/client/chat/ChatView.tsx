...
export function ChatView({
  ...
  sessionId, openFile, loadOlder, loadThrough, loadImage, openView, chatScroll, forkAt,
  rewindAt, openVersion, consumeVersionJump, fileMentions, useTranscriptView, useProjection, t,
}: ChatViewSlotProps) {
